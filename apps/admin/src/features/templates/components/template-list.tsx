    ...
    <div className="space-y-6">
      ...
      <Card className="bg-amber-50 border-amber-200">
        ...
        <CardContent className="text-amber-700 space-y-2 text-sm">
          <p>
            ...
            템플릿을 조회하고 관리하는 페이지입니다. 각 템플릿은 특정 치수
            규칙과 연결되어 있으며, 자동으로 계산된 템플릿명, 도구 유형, 차트
            유형 등의 정보를 표시합니다.
          </p>
          <p>
          ...
          <ol className="list-decimal pl-5 space-y-1">
            ...
            <li>
              템플릿명은 카테고리, 제작 방식, 넥라인, 소매 유형 등을 조합하여
              자동 생성
            </li>
          ...
          <p className="mt-3 bg-blue-50 p-2 rounded text-blue-800">
            ...
            <strong>UI 팁:</strong> 템플릿 생성 시 입력한 값에 따라 템플릿명이
            자동으로 생성되며, 세부 치수는 엑셀에서 값을 복사하여 한번에
            붙여넣기할 수 있습니다.
          </p>
        </CardContent>
      </Card>
      ...
      <div className="flex justify-end">
        <Link href="/templates/new">
          <Button size="lg">새 템플릿 추가</Button>
        </Link>
      </div>
